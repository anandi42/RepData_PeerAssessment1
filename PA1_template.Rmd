...
```{r plot4, dependson=c(2,3,6), fig.cap="Daily activity on Weekdays vs. Weekends", fig.width=8}
...
```{r extra, dependson=c(2,3,6,7,8), fig.cap="Additional plots", fig.width=8}
act5 <- act3 %>%
  group_by(date,dow) %>%
  summarize(steps=sum(steps))
